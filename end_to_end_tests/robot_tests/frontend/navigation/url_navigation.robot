...
Test Series History Url Navigation With Offset Parameters
    Open history page of series with url params  TestArchiver   3   0   5
    History Table should be limited to    number=5
    Left Button Should be disabled

    Open history page of series with url params  TestArchiver   3   1   10
    ...
    Open history page of series with url params  TestArchiver   3   2   15
...
Test Series History Url Navigation With Failing
    Open history page of series with checkbox set  TestArchiver   3   Passing
    Checkbox is ticked for  Passing

    Open history page of series with checkbox set  TestArchiver   3   Failing
